    ...
    <div className="min-h-screen bg-canvas">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-8 md:p-12">
          ...
          <p className="text-stone-600 mb-8">Last Updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
          ...
          <div className="prose prose-indigo max-w-none space-y-8">
            ...
            {/* What We Collect */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">2. Information We Collect</h2>
              
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Account Information</h3>
              ...
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Trip Information (User-Provided)</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Automatically Collected</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">3. How We Use Your Information</h2>
              <p className="text-stone-700 leading-relaxed mb-3">We use your information to:</p>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">4. Who Can See Your Information</h2>
              ...
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Logged-In Users</h3>
              ...
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">NOT Visible to Public</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Service Providers</h3>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Data Security */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">5. Data Security</h2>
            ...
            {/* Your Rights & Choices */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">6. Your Rights & Choices</h2>
              
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Access & Update</h3>
              <p className="text-stone-700 leading-relaxed">
                You can view and update your trip posts anytime from your "My Trips" dashboard.
              </p>

              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Delete Your Data</h3>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-stone-900 mb-2 mt-4">Opt-Out of Emails</h3>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Data Retention */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">7. Data Retention</h2>
              <ul className="list-disc pl-6 text-stone-700 space-y-2">
            ...
            {/* Children's Privacy */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">8. Children's Privacy</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* International Users */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">9. International Users</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Changes to Policy */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">10. Changes to This Policy</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">11. Contact Us</h2>
              <p className="text-stone-700 leading-relaxed mb-3">
            ...
            <section className="border-t pt-6 mt-8 bg-primary-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-stone-900 mb-3">Privacy Policy Summary</h3>
