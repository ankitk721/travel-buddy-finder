...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    if (data.user) {
      setMessage('Success! Check your email to verify your account before logging in.')
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-canvas flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-xl border border-stone-200 shadow-sm p-8">
        <h2 className="text-3xl font-bold text-center mb-2 text-stone-900">Create Account</h2>
        <p className="text-center text-stone-600 mb-8">Join Travel Buddy Finder</p>
        ...
        <button
          ...
          type="button"
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-stone-300 rounded-lg hover:bg-stone-50 transition font-medium text-stone-700 mb-6"
        >
        ...
        <form onSubmit={handleEmailSignup} className="space-y-4">
          <div>
            ...
            />
            <p className="mt-1.5 text-sm text-stone-600 flex items-start gap-1.5">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
            ...
            <ul className="text-stone-700 space-y-1 text-xs">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-600 text-white py-3 rounded-lg font-semibold hover:bg-primary-700 transition disabled:bg-stone-400 disabled:cursor-not-allowed"
          >
