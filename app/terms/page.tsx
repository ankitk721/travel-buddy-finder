      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-indigo max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">2. What This Service Is</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">3. User Responsibilities</h2>
              <p className="text-stone-700 leading-relaxed mb-3">
            ...
            {/* Prohibited Uses */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">4. Prohibited Uses</h2>
              <p className="text-stone-700 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">5. Contact Information & Privacy</h2>
              <p className="text-stone-700 leading-relaxed mb-3">
            ...
            {/* Account Management */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">6. Account Management</h2>
              <p className="text-stone-700 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">7. Disclaimer of Warranties</h2>
              <p className="text-stone-700 leading-relaxed">
                <strong>USE AT YOUR OWN RISK.</strong> Travel Buddy Finder is provided "AS IS" without 
                warranties of any kind. We do not:
              </p>
              <ul className="list-disc pl-6 text-stone-700 space-y-2 mt-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">8. Limitation of Liability</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* User Conduct & Safety */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">9. User Safety</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Changes to Terms */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">10. Changes to Terms</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Governing Law */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">11. Governing Law</h2>
              <p className="text-stone-700 leading-relaxed">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-bold text-stone-900 mb-3">12. Contact Us</h2>
              <p className="text-stone-700 leading-relaxed">
