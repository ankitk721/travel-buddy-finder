    ...
    <div className="min-h-screen bg-canvas">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-8">
          <h1 className="text-3xl font-bold text-stone-900 mb-2">Find a Travel Companion</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b pb-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-2">Your Information</h2>
            ...
            {/* Traveler Info */}
            <div className="border-b pb-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-4">Traveler Information</h2>
            ...
            {/* Flight Route */}
            <div className="border-b pb-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-4">Travel Route</h2>
            ...
            {/* Booking Status */}
            <div className="border-b pb-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-4">Booking Status</h2>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-stone-700">Flight Already Booked</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="mr-2"
                    />
                    <span className="text-stone-700">Flexible Dates (Not Booked Yet)</span>
                  </label>
                </div>
            ...
            {/* Companion Type */}
            <div className="border-b pb-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-4">What describes you best?</h2>
              
              <div className="space-y-3">
                <label className="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-stone-50 transition">
                  <input
                    type="radio"
                    name="companion_type"
                  ...
                  />
                  <div>
                    <span className="font-medium text-stone-900 text-lg">Need a Companion</span>
                ...
                <label className="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-stone-50 transition">
                  ...
                  />
                  <div>
                    <span className="font-medium text-stone-900 text-lg">Willing to Help as Companion</span>
                    <p className="text-sm text-stone-600 mt-1">
            ...
            {/* Help Needed */}
            <div className="border-b pb-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-4">Help Needed With</h2>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 space-y-4">
              ...
              {/* Privacy Notice */}
              <div className="text-sm text-stone-700 space-y-2 bg-white p-4 rounded border border-blue-100">
                <p className="font-medium text-stone-900">Before you post, please understand:</p>
            ...
            <button
              ...
              className="w-full bg-primary-600 text-white py-4 rounded-lg font-semibold hover:bg-primary-700 transition disabled:bg-stone-400 disabled:cursor-not-allowed text-lg"
            >
